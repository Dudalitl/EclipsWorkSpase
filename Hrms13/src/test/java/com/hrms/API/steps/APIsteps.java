...
public class APIsteps {
	...
	@Then("the employee ID is stored as a global variable to be used for other")
	public void the_employee_ID_is_stored_as_a_global_variable_to_be_used_for_other() {
	}
